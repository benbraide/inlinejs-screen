import { AddChanges, GetGlobal } from "@benbraide/inlinejs";
...
export class ScreenConcept {
    ...
    PassValue_(prop, value) {
        var _a, _b;
        const componentId = (_a = this.component_) === null || _a === void 0 ? void 0 : _a.GetId();
        componentId && ((_b = GetGlobal().GetCurrentProxyAccessStorage()) === null || _b === void 0 ? void 0 : _b.Put(componentId, `${this.id_}.${prop}`));
        return value;
    }
    HandleResize_() {
        var _a, _b;
